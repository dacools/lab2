...
def parse_balboa_msg(data, self):
    ...
    if abs(dist_curr - self.dist) < 10 and abs(ang_curr - self.ang) < 2 and self.state < 15: #37:
    ...
    elif self.state == 15: # Show that we are done mapping
        self.move(200)
        self.state = self.state + 1
...
class TheNode(object):
    ...
    def __init__(self):
        ...
        self.seq = seq1 + seq2 + seq1 + seq3 + seq1
